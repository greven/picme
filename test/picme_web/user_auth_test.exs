defmodule PicmeWeb.UserAuthTest do
  use PicmeWeb.ConnCase

  alias Phoenix.LiveView
  alias Picme.Accounts
  alias PicmeWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, PicmeWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      PicmeWeb.Endpoint.subscribe(live_socket_id)
